...
export const servicePages: SectionPage[] = [
  {
    ...
    title: "Buying",
    eyebrow: "Services",
    headline: "From first enquiry to plot selection",
    description:
      "End-to-end support for buyers exploring villa plots across Bengaluru’s eastern corridors.",
    body: [
  ...
  },
  {
    ...
    description:
      "Clear approval trails, title checks and compliance details for every layout we represent.",
    body: [
      "Every project comes with approvals you can verify — MPA, RERA where applicable, and layout plans you can review with your advocate.",
      "We coordinate encumbrance checks, banker introductions and registration support so you are not navigating government offices alone.",
  ...
  },
  {
    ...
    body: [
      ...
      "Complaints and feedback are handled directly — reach us by phone, email or WhatsApp.",
    ],
    highlights: [
      "Possession handover",
