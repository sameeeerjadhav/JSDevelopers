...
const HOME_CARDS: StackCard[] = [
  ...
  },
  {
    ...
    alt: "Dhanapriya Paradise premium villa plots at Madanahatti, Malur",
    title: "Dhanapriya Paradise",
    subtitle: "Near Malur Whitefield Road",
  },
  {
    id: "kanakasree-enclave",
    src: "/projects/kanakasree-enclave/hero.jpg",
    alt: "Kanakasree Enclave plot site at Lingapura, Malur",
  ...
  },
  {
    ...
    alt: "Royal Meadows villa elevation at Doddakadathur, Malur",
    title: "Royal Meadows",
    subtitle: "Doddakadathur · Malur",
  },
  {
...
const HERO_COPY = [
  ...
  },
  {
    ...
    headline: "Plots near the Bengaluru–Chennai express corridor.",
    body: "Royal Meadows at Doddakadathur, Malur — DC-converted, MPA-approved 30×40 and odd sites within 1 km of the 300 ft express corridor.",
