...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className={`fixed right-4 z-40 grid h-12 w-12 place-items-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-105 sm:bottom-5 sm:right-5 sm:h-14 sm:w-14 ${
        onProjectDetail
          ? "bottom-5 max-md:hidden"
